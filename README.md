...
<html>
    <head>
        ...
        <h1 align="center">Mugil Raj S A(212223220062)</h1>
    </head>
    <body bgcolor="silver"> 
        <img src="map2.png" usemap="#image-map">
        <map name="image-map">
            <area target="" alt="Padmanabha Swamy Temple" title="Padmanabha Swamy Temple" href="temple.html" coords="1003,491,1198,535" shape="rect">
...
<head>
    ...
    <body bgcolor="Mistyrose">
        ...
        <img align="right" src="temple.png">
        <br><br>
...
<html>
    ...
    <body bgcolor="aquamarine">
        ...
        <img align="right" src="zoo.png" height="600" width="900">
        <br><br>
 ...
 <html>
    ...
    <body bgcolor="Navajowhite">
        ...
        <img align="right" src="lake.png" height="600" width="900">
        <br><br>
...
<html>
    ...
    <body bgcolor="LightSkyBlue">
        ...
        <img align="right" src="airport.png" height="600" width="900">
        <br><br>
 ...
 <html>
    ...
    <body bgcolor="Crimson">
        ...
        <img align="right" src="attu.png" height="700" width="600">
        <br><br>
...
![alt text](mugil/mapapp/static/1.png)
![alt text](mugil/mapapp/static/2.png)
![alt text](mugil/mapapp/static/3.png)
![alt text](mugil/mapapp/static/4.png)
![alt text](mugil/mapapp/static/5.png)
![alt text](mugil/mapapp/static/6.png)
## RESULT
